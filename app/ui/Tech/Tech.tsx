...
function Tech(){
    return(
        <div className="flex flex-col justify-between gap-5">
            <h2 id="tech" className={`${jost.className} flex justify-start text-6xl px-20 py-4 ml-12 ease out after:w-2/3 after:-scale-x-0 after:origin-left after:border-b-2 after:border-slate-400 after:transition-transform after:duration-1000 after:hover:-scale-x-150`}>Technologies</h2>
